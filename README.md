...
> I'm keeping a close eye on the official http2 implementation for Node.js [here](https://github.com/nodejs/http2). Version 3.0 will be released as soon as that repo is merged to Node core.
